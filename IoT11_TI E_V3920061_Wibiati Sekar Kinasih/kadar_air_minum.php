...
<head>
    ...
    <title>Halaman Kadar Air Minum | Simkasu</title>
    <meta charset="utf-8">
    ...
    <main class="app-content">
        ...
        <div class="container" style="margin-top:20px">
            ...
            <table class="table table-striped table-hover table-sm table-bordered">
                ...
                <tbody>
                    <?php
                    //query ke database SELECT tabel ph_air urut berdasarkan id_ph_air yang paling besar
                    $sql = mysqli_query($koneksi, "SELECT * FROM ph_air ORDER BY id_ph_air DESC") or die(mysqli_error($koneksi));
                    ...
                    if (mysqli_num_rows($sql) > 0) {
						...
						<tr>
                            ...
                            echo'
							<td>
								<a href="edit_kam.php?id_ph_air=' . $data['id_ph_air'] . '" class="badge badge-warning">Edit</a>
								<a href="delete_kam.php?id_ph_air=' . $data['id_ph_air'] . '" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
						</tr>
						';
                            $no++;
